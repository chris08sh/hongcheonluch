document.addEventListener("DOMContentLoaded", () => {
    ...
    const menuData = {
        ...
        "2024-10-28": ["쌀밥", "왕만두국", "마늘쫑어묵볶음", "떡갈비그라탕", "메론"],
        "2024-10-29": ["차조수수밥", "치짜", "깍두기", "양배추샐러드", "스틱마늘바게트", "청사과에이드", "옥수수스프"],
        "2024-10-30": ["팽이미소국", "함바그동", "배추겉절이", "골라먹는쁘띠첼", "코코넛쉬림프샐러드"],
        "2024-10-31": ["찰보리밥", "건새우아욱수제비국", "간장무채숙주무침", "잡채김말이강정", "돈목살양념구이", "배추김치"]
    };
